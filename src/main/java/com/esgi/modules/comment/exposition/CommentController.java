...
public class CommentController {
    ...
    @GetMapping(path = "/comments/user={id}", produces = {MediaType.APPLICATION_JSON_VALUE})
    ...
    @GetMapping(path = "/comments/post={id}", produces = {MediaType.APPLICATION_JSON_VALUE})
    ...
    @PutMapping(path = "/comment/{id}/edit", consumes = MediaType.APPLICATION_JSON_VALUE, produces = {MediaType.APPLICATION_JSON_VALUE})
